...
export const saveConnection = (Item: Connection): Promise<DocumentClient.PutItemOutput> => dynamoPutItem({
  TableName: 'chat-websocket-connections',
  Item,
})

export const removeConnection = (connectionId: string): Promise<DocumentClient.DeleteItemOutput> => dynamoDeleteItem({
  TableName: 'chat-websocket-connections',
  Key: { connectionId },
})
